            ...
            <div class="flex col w-1/2 min-h-screen bg-black text-[#061826] mb-8 ">
                ...
                <h1 class=" flex flex-col text-white font-bold text-6xl mt-12">Dell Conect</h1>
                    ...
                    <div class="flex flex-col pt-8 items-center">
                        <button class="bg-[#8A58DC] text-white font-bold py-2 w-3/4 rounded ml-10 mr-10">Login</button>
                        
                        <div class="flex py-5 items-center">
                            <div class="flex-grow border-t border-gray-400 h-0.5"></div>
                                <span class="flex-shrink mx-4 text-gray-400">Or</span>
                            <div class="flex-grow border-t border-gray-400 h-0.5"></div>
                        </div> 

                        <button class="bg-[#f8f8f8] text-[#454545] font-bold py-2 w-3/4 rounded ml-10 mr-10">Login with Dell SSO</button>
